    ...
    return (
        ...
        <div id="slide1" className="carousel-item relative w-full ">
          ...
          <div className="absolute  rounded-xl h-full bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
            <div className='top-1/3 space-y-8  w-1/2 ml-8 mt-36'>
                <h1 className='text-4xl font-bold text-white'>Affordable price for car servicing</h1>
            <p className='text-xl text-white'>There are many variables of passages of available, but the majority have suffered alteration in some form</p>
          <div>
          ...
          <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
            <a href="#slide4" className="btn btn-error mr-4">❮</a> 
        ...
        <div id="slide2" className="carousel-item relative w-full">
          ...
          <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
            <a href="#slide1" className="btn btn-error mr-4">❮</a> 
        ...
        <div id="slide3" className="carousel-item relative w-full">
          ...
          <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
            <a href="#slide2" className="btn btn-error mr-4">❮</a> 
        ...
        <div id="slide4" className="carousel-item relative w-full">
          ...
          <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
            <a href="#slide3" className="btn btn-error mr-4">❮</a> 
